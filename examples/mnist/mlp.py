# -*- coding: utf-8 -*-
"""
This is an example of training MLP on Mnist with fixed constraints.
Optionally, the trained weights can be saved.
"""
...
def main(_):
    ...
    if FLAGS.train_dir:
        print("Saving model to: ", saver.save(sess, FLAGS.train_dir))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_dir", type=str, default="",
                        help="Directory for storing snapshots. If not specified, no snapshots will be saved.")
